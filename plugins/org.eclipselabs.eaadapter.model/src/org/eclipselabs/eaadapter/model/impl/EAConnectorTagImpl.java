...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>EA Connector Tag</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipselabs.eaadapter.model.impl.EAConnectorTagImpl#getObjectType <em>Object Type</em>}</li>
 *   <li>{@link org.eclipselabs.eaadapter.model.impl.EAConnectorTagImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.eclipselabs.eaadapter.model.impl.EAConnectorTagImpl#getRepository <em>Repository</em>}</li>
 *   <li>{@link org.eclipselabs.eaadapter.model.impl.EAConnectorTagImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipselabs.eaadapter.model.impl.EAConnectorTagImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link org.eclipselabs.eaadapter.model.impl.EAConnectorTagImpl#getGuid <em>Guid</em>}</li>
 *   <li>{@link org.eclipselabs.eaadapter.model.impl.EAConnectorTagImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.eclipselabs.eaadapter.model.impl.EAConnectorTagImpl#getTagID <em>Tag ID</em>}</li>
 *   <li>{@link org.eclipselabs.eaadapter.model.impl.EAConnectorTagImpl#getEaLink <em>Ea Link</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EAConnectorTagImpl extends EObjectImpl implements EAConnectorTag {
	 ...
	 * @ordered
	 */
	protected ConnectorTag eaLink = null;
	...
	protected EClass eStaticClass() {
		return EamodelPackage.Literals.EA_CONNECTOR_TAG;
	}
		...
		if (repository != null && repository.eIsProxy()) {
			...
			if (repository != oldRepository) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EamodelPackage.EA_CONNECTOR_TAG__REPOSITORY, oldRepository, repository));
			}
		}
		// return value
		return repository;
	...
	public void setRepository(EARepository newRepository) {
		...
		repositoryESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EamodelPackage.EA_CONNECTOR_TAG__REPOSITORY, oldRepository, repository, !oldRepositoryESet));
	}
	...
	public void unsetRepository() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EamodelPackage.EA_CONNECTOR_TAG__REPOSITORY, oldRepository, null, oldRepositoryESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EamodelPackage.EA_CONNECTOR_TAG__NAME, oldName, name));
	}
	...
	public void setNotes(String newNotes) {
		...
		notes = newNotes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EamodelPackage.EA_CONNECTOR_TAG__NOTES, oldNotes, notes));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EamodelPackage.EA_CONNECTOR_TAG__VALUE, oldValue, value));
	}
	...
	public void setEaLink(ConnectorTag newEaLink) {
		...
		eaLink = newEaLink;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EamodelPackage.EA_CONNECTOR_TAG__EA_LINK, oldEaLink, eaLink));
	}
	...
	public Boolean initializeAdapter(Collection collection) {
		...
		try {
			...
			ConnectorTag newEaLink = (ConnectorTag)collection.AddNew("", "");
			if (newEaLink != null) {
				setEaLink(newEaLink);
	...
	public Boolean deleteAdapter(Collection collection) {
		...
		try {
			...
			for (int i = count - 1; i >= 0; i--) {
				ConnectorTag collElement = (ConnectorTag) collection.GetAt((short) i);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EamodelPackage.EA_CONNECTOR_TAG__OBJECT_TYPE:
				return getObjectType();
			case EamodelPackage.EA_CONNECTOR_TAG__ID:
				return getId();
			case EamodelPackage.EA_CONNECTOR_TAG__REPOSITORY:
				if (resolve) return getRepository();
				return basicGetRepository();
			case EamodelPackage.EA_CONNECTOR_TAG__NAME:
				return getName();
			case EamodelPackage.EA_CONNECTOR_TAG__NOTES:
				return getNotes();
			case EamodelPackage.EA_CONNECTOR_TAG__GUID:
				return getGuid();
			case EamodelPackage.EA_CONNECTOR_TAG__VALUE:
				return getValue();
			case EamodelPackage.EA_CONNECTOR_TAG__TAG_ID:
				return getTagID();
			case EamodelPackage.EA_CONNECTOR_TAG__EA_LINK:
				return getEaLink();
		}
	 ...
	 * @generated
	 */
	private boolean updateEaLink(ConnectorTag eaLink) {
