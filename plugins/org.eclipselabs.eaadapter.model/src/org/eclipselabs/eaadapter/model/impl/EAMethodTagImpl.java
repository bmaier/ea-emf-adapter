...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>EA Method Tag</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipselabs.eaadapter.model.impl.EAMethodTagImpl#getObjectType <em>Object Type</em>}</li>
 *   <li>{@link org.eclipselabs.eaadapter.model.impl.EAMethodTagImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.eclipselabs.eaadapter.model.impl.EAMethodTagImpl#getRepository <em>Repository</em>}</li>
 *   <li>{@link org.eclipselabs.eaadapter.model.impl.EAMethodTagImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipselabs.eaadapter.model.impl.EAMethodTagImpl#getNotes <em>Notes</em>}</li>
 *   <li>{@link org.eclipselabs.eaadapter.model.impl.EAMethodTagImpl#getGuid <em>Guid</em>}</li>
 *   <li>{@link org.eclipselabs.eaadapter.model.impl.EAMethodTagImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.eclipselabs.eaadapter.model.impl.EAMethodTagImpl#getTagID <em>Tag ID</em>}</li>
 *   <li>{@link org.eclipselabs.eaadapter.model.impl.EAMethodTagImpl#getEaLink <em>Ea Link</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EAMethodTagImpl extends EObjectImpl implements EAMethodTag {
	/**
	 ...
	 * @ordered
	 */
	protected static final MethodTag EA_LINK_EDEFAULT = null;
	 ...
	 * @ordered
	 */
	protected MethodTag eaLink = null;
	...
	protected EClass eStaticClass() {
		return EamodelPackage.Literals.EA_METHOD_TAG;
	}
		...
		if (repository != null && repository.eIsProxy()) {
			...
			if (repository != oldRepository) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EamodelPackage.EA_METHOD_TAG__REPOSITORY, oldRepository, repository));
			}
		}
		// return value
		return repository;
	...
	public void setRepository(EARepository newRepository) {
		...
		repositoryESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EamodelPackage.EA_METHOD_TAG__REPOSITORY, oldRepository, repository, !oldRepositoryESet));
	}
	...
	public void unsetRepository() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EamodelPackage.EA_METHOD_TAG__REPOSITORY, oldRepository, null, oldRepositoryESet));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EamodelPackage.EA_METHOD_TAG__NAME, oldName, name));
	}
	...
	public void setNotes(String newNotes) {
		...
		notes = newNotes;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EamodelPackage.EA_METHOD_TAG__NOTES, oldNotes, notes));
	}
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EamodelPackage.EA_METHOD_TAG__VALUE, oldValue, value));
	}
	 ...
	 * @generated
	 */
	public void setEaLink(MethodTag newEaLink) {
		...
		eaLink = newEaLink;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EamodelPackage.EA_METHOD_TAG__EA_LINK, oldEaLink, eaLink));
	}
	...
	public Boolean initializeAdapter(Collection collection) {
		...
		try {
			...
			MethodTag newEaLink = (MethodTag)collection.AddNew("", "");
			if (newEaLink != null) {
				setEaLink(newEaLink);
	...
	public Boolean deleteAdapter(Collection collection) {
		...
		try {
			...
			for (int i = count - 1; i >= 0; i--) {
				MethodTag collElement = (MethodTag) collection.GetAt((short) i);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EamodelPackage.EA_METHOD_TAG__ID:
				return getId();
			case EamodelPackage.EA_METHOD_TAG__REPOSITORY:
